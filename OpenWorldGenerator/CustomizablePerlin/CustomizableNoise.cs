...
namespace OpenWorldGenerator.CustomizablePerlin
{
    class WorldGenerator
    {
        CustomizableNoise _perlinCustomizableNoise;
        ...
        public WorldGenerator()
        {
            ...
            _perlinCustomizableNoise = new CustomizableNoise(persistence, frequency, amplitude, octaves, seed);
        }

        public byte Generate(Vector3 blockPos)
        {
            double posHeight = _perlinCustomizableNoise.Get2D(blockPos.X, blockPos.Z);
            return (byte) posHeight;
        }
    }

    class CustomizableNoise
    {
        double persistence;
        double frequency;
        double amplitude;
        ...
        public CustomizableNoise(double persistence, double frequency, double amplitude, int octaves, int randomSeed)
        {
